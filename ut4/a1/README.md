...
|:-------------------------:|:-----------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|:-----------------:|:-----------------------------------------------------------------------------------------------------------------------:|
|          Usuario          |     Herencia      |                       De la tabla usuario, se heredara el nombre, correo y el inicio de sesion para cada alumno y profesor                       |       1 a 1       | Es 1 a 1 tanto para los profesores como los alumnos, ya que solo pueden tener un usuario correspondiente a su identidad |
|           Curso           |    Dependencia    |                                               De el dependen el modulo ya que si el no hay modulos                                               |    muchos a 1     |  Muchos modulos pueden estar un curso, muchos alumnos pueden estar en un curso y muchos profesores pueden dar un curso  |
| resultado calificaciones  |    dependencia    | el resultado evaluable es la herencia de las notas obtenidas por los alumnos al realizar las actividades evaluable corregidas por los profesores | muchos a 1, 1 a 1 |                                                                                                                         |
|                           |                   |                                                                                                                                                  |                   |                                                                                                                         |
|                           |                   |                                                                                                                                                  |                   |                                                                                                                         |
|                           |                   |                                                                                                                                                  |                   |                                                                                                                         |
|                           |                   |                                                                                                                                                  |                   |                                                                                                                         |
